classdef SineGeneratorV2 < symphonyui.core.StimulusGenerator
    % Generates a sinewave-modulated gaussian noise stimulus.  Built based
    % on GaussianNoiseGeneratorV2. V2 corrected so that mean is correct
    % throughout stim.
    ...
    methods
        ...
        function obj = SineGeneratorV2(map)
            if nargin < 1
                map = containers.Map();
            end
    ...
    methods (Access = protected)
        ...
        function s = generateStimulus(obj)
            ...
            sinStim = sin((0:stimPts-1)*2*pi*obj.sinFreq/obj.sampleRate) * obj.mean * obj.contr * obj.mult + obj.mean;
