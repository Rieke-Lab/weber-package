    ...
    methods
        ...
        function prepareRun(obj)
            ...
            if length(obj.spotContrast) > 1
                colors = edu.washington.riekelab.weber.utils.pmkmp(length(obj.spotContrast),'CubicYF');
            else
                colors = [0 0 0];
            end
            obj.showFigure('symphonyui.builtin.figures.ResponseFigure', obj.rig.getDevice(obj.amp));
            obj.showFigure('edu.washington.riekelab.weber.figures.MeanResponseFigure',...
