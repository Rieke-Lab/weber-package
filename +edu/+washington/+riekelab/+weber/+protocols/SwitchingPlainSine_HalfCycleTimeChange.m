classdef SwitchingPlainSine_HalfCycleTimeChange < edu.washington.riekelab.protocols.RiekeLabProtocol
    ...
    properties
        ...
        halfPeriodDur1 = .5             % Duration of first half (s)
        halfPeriodDur2 = 2              % Duration of second half (s)
