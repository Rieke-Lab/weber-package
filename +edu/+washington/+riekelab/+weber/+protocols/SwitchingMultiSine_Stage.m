classdef SwitchingMultiSine_Stage < edu.washington.riekelab.protocols.RiekeLabStageProtocol
    ...
    methods
        ...
        function prepareEpoch(obj, epoch)
            ...
            roundedPeriodDur = round(obj.periodDur/2/(1/min(obj.sinFreqs)))*(1/min(obj.sinFreqs))*2;
            if  positionInBlock == obj.epochsPerBlock ||  positionInBlock == obj.epochsPerBlock *2
                periodDurActual = roundedPeriodDur + 1/min(obj.sinFreqs)/2;
            else
        ...
        function p = createPresentation(obj)
            ...
            function i = getStimIntensity(obj, frame, epochNum)
                ...
                intensity = intensity/(max(intensityAll)-min(intensityAll));
